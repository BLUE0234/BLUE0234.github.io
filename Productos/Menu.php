...
<body>
  ...
  <h1 class="text-center p-3 alert alert-secondary">Productos</h1>
  <?php
  ...
  <div class="container-fluid row">
   <form class="col-4 p-3" method="POST">
    <h3 class="text-center alert ">Registro de Productos</h3>
    <?php 
    include "modelo/Conexion.php";
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a onclick="return eliminar()" href="Menu.php?id=<?= $datos->id_producto ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
      </td>
    </tr>
