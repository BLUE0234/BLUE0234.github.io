...
<body>
  ...
  <h1 class="text-center p-3 alert alert-secondary">Clientes</h1>
  <?php
  ...
  <div class="container-fluid row">
   <form class="col-4 p-3" method="POST">
    <h3 class="text-center alert ">Registro de Clientes</h3>
    <?php 
    include "modelo/Conexion.php";
  ...
  <tbody>
    <?php 
    include "modelo/Conexion.php";
    $sql=$Conexion->query(" select * from Cliente2");
    ...
    <tr>
      ...
      <td>
        ...
        <a onclick="return eliminar()" href="Menu.php?id=<?= $datos->id_cliente ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
      </td>
    </tr>
