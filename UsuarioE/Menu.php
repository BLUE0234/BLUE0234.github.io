...
<body>
  ...
  <h1 class="text-center p-3 alert alert-secondary">Usuario Empleado</h1>
  <?php
  include "modelo/Conexion.php";
  include "controlador/Eliminar_UsuarioE.php"
  ?>
  <div class="container-fluid row">
   <form class="col-4 p-3" method="POST">
    <h3 class="text-center alert ">Registro de Usuarios</h3>
    <?php 
    include "modelo/Conexion.php";
    include "controlador/registro_usuarioe.php";
    ?>
  <div class="mb-3">
  ...
  <tbody>
    <?php 
    include "modelo/Conexion.php";
    $sql=$Conexion->query(" select * from Usuario_Empleado");
    ...
    <tr>
      ...
      <td>
        <a href="Modificar_UsuarioE.php?id=<?= $datos->id_usuario ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
        <a onclick="return eliminar()" href="Menu.php?id=<?= $datos->id_usuario ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
      </td>
    </tr>
