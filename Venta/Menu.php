...
<body>
  ...
  <h1 class="text-center p-3 alert alert-secondary">Ventas</h1>
  <?php
  ...
  <div class="container-fluid row">
   <form class="col-4 p-3" method="POST">
    ...
    <?php 
    include "modelo/Conexion.php";
    include "controlador/registro_venta.php";
    ?>
  <div class="mb-3">
  ...
  <tbody>
    ...
    <tr>
      <th><?=$datos->id_venta ?></th>
      <td><?=$datos->fecha ?></td>
      <td><?=$datos->total ?></td>
      <td>
        <a href="Modificar_Venta.php?id=<?= $datos->id_venta ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
        <a onclick="return eliminar()" href="Menu.php?id=<?= $datos->id_venta ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
      </td>
    </tr>
