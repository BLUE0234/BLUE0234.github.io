...
<body>
  ...
  <h1 class="text-center p-3 alert alert-secondary">Compra</h1>
  <?php
  ...
  <div class="container-fluid row">
   <form class="col-4 p-3" method="POST">
    <h3 class="text-center alert ">Registro de Compra</h3>
    <?php 
    include "modelo/Conexion.php";
    include "controlador/registro_compra.php";
    ?>
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Fecha_Compra</label>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a onclick="return eliminar()" href="Menu.php?id=<?= $datos->id_compra ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
      </td>
    </tr>
