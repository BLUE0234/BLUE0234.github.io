...
<body>
  ...
  <h1 class="text-center p-3 alert alert-secondary">Usuario Cliente</h1>
  <?php
  include "modelo/Conexion.php";
  include "controlador/Eliminar_UsuarioC.php"
  ?>
  <div class="container-fluid row">
   <form class="col-4 p-3" method="POST">
    ...
    <?php 
    include "modelo/Conexion.php";
    include "controlador/registro_usuarioc.php";
    ?>
  <div class="mb-3">
  ...
  <tbody>
    <?php 
    include "modelo/Conexion.php";
    $sql=$Conexion->query(" select * from Usuario_Cliente");
    ...
    <tr>
      ...
      <td>
        <a href="Modificar_UsuarioC.php?id=<?= $datos->id_usuario ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
