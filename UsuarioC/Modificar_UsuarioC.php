...
$sql=$Conexion->query(" select * from Usuario_Cliente where id_usuario=$id ")
...
<form class="col-4 p-3 m-auto" method="POST">
    <h3 class="text-center alert alert-secondary">Modificar Cliente</h3>
    <input type="hidden" name="id" value="<?= $_GET["id"] ?>">
    <?php 
    include "controlador/Modificar_UsuarioC.php";
