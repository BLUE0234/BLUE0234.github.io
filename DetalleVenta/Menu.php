...
<body>
  ...
  <h1 class="text-center p-3 alert alert-secondary">Detalle de Venta</h1>
  <?php
  include "modelo/Conexion.php";
  include "controlador/Eliminar_DetalleV.php"
  ?>
  <div class="container-fluid row">
   <form class="col-4 p-3" method="POST">
    <h3 class="text-center alert ">Registro de Ventas</h3>
    <?php 
    include "modelo/Conexion.php";
    include "controlador/registro_DetalleV.php";
    ?>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" name="id_empleado">
  </div>
  <div class="mb-3">
  ...
  <tbody>
    <?php 
    include "modelo/Conexion.php";
    $sql=$Conexion->query(" select * from Detalle_Venta");
    while($datos=$sql->fetch_object()){  ?>

    <tr>
      <th><?=$datos->id_detalle ?></th>
      ...
      <td>
        <a href="Modificar_DetalleV.php?id=<?= $datos->id_detalle ?>" class="btn btn-small btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
        <a onclick="return eliminar()" href="Menu.php?id=<?= $datos->id_detalle ?>" class="btn btn-small btn-danger"><i class="fa-solid fa-trash"></i></a>
      </td>
    </tr>
